...
1. **DOWNLOAD NEW WABBAJACK FILE AND ALWAYS "OVERWRITE INSTALL"** 

2. **APPLY NEW MCM, EXIT MCM AND THEN GO BACK INTO THE MCM**

3. **APPLY ADVANCE NEEDS & sub systems, - YOU MUST ENABLE OTHER SYSTEM MANUALLY AS WELL, SEE BELOW FOR INFO! - MAKE A SAVE**

4. **GO TO AN INTERIOR CELL AND WAIT NO LESS THAN 72 HOURS! IT IS ADVISED TO RESTART YOUR GAME TO ENSURE EVERYTHING UPDATES**
...
- Performance changes have been added to help address reports, feel free to change out the ENB to something more appropriate for your system.
...
- Coughs: Lowered.
- Flashlights:
  - Now use fusion cells to power on.
